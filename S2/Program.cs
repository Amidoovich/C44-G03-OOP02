...
namespace S2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //rectangle.Width = -2; // the  set value doesn't work bec the value is negative and will print error  and width will be with default value of integer
            //rectangle.Height = 4;

            //Console.WriteLine(rectangle.DisplayInfo()); // will print area = 0 and weight = 0 and hieght = 4

            //rectangle.Width = 3; // this will work
            

            //Console.WriteLine(rectangle.DisplayInfo()); // will print area = 12 and width = 3 and hight = 4
